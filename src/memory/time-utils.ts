...
/**
 * Extract a timestamp from session JSONL content within a chunk range.
 * Returns the earliest timestamp found, or null.
 */
export function extractSessionChunkTimestamp(
  content: string,
  _startLine?: number,
  _endLine?: number,
): number | null {
